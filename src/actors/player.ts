...
export class Player extends Actor {
    ...
    onInitialize(engine: Engine<any>): void {
        ...
        engine.input.keyboard.on("release", (event) => {
            ...
            // Ao parar o player,definir animação idle da última direção
        ...
        // Configura o layer para monitorar o evento "press" -> pressionar
    ...
    // Self -> player///Other -> outro objt colidido
    onPreCollisionResolve(self: Collider, other: Collider, side: Side, contact: CollisionContact): void {
        // Para pegar o nome do objeto que foi colidido -> console.log(other.owner.name);
    ...
    onPostUpdate(engine: Engine<any>, delta: number): void {
            // para atualizar a tela (60 fps) (atualização de frame)
